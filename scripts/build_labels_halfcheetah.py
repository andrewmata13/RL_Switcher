"""
Build the adversarial-detection labeling dataset for HalfCheetah.
...
from halfcheetah_ags_rs_switcher.controllers import CheetahPerfPolicy
from halfcheetah_ags_rs_switcher.labeling import CheetahCriticalBurstLabeler


def collect_state_stats(perf: CheetahPerfPolicy, episodes: int = 5) -> tuple:
    """Collect mean/std of normalized observations over clean rollouts."""
    states = []
...
def main():
    ...
    parser.add_argument("--dataset-out",     type=str,
                        default="data/halfcheetah_critical_dataset.npz")
    ...
    labeler = CheetahCriticalBurstLabeler(perf, cfg=None,
